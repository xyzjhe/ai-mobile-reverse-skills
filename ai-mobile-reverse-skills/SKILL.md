...
4. 若只提供了抓包材料和代码目录，则从 Phase 2 开始。
5. 若只提供了 IDA / Ghidra / so 材料，则从 Phase 3 开始。
...
- 当 Phase 1 采用 `jadx_mcp_session` 路径时，不默认执行上述 4 个脚本，优先直接消费 `jadx-mcp` 上下文
